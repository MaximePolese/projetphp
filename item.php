...
<section class="container">
    <article class="product d-flex flex-row">
        <h2 class="nomDuProduit p-2"><?php echo $products["trail 30"]["name"] ?></h2>
        <p class="productDescription p-2">Description : <?php echo $description ?></p>
        <img class="productPic" src="<?php echo $products["trail 30"]["picture_url"] ?>" alt="">
        <div class="d-flex flex-column">
        <p>Poids : <?php echo $products["trail 30"]["weight"] ?> gr</p>
        <p>Prix : <?php echo $products["trail 30"]["price"] ?> €</p>
        <p>Remise : <?php echo $products["trail 30"]["discount"] ?> %</p>
        </div>
    </article>
</section>
